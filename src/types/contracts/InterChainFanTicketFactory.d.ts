...
interface InterChainFanTicketFactoryInterface extends ethers.utils.Interface {
  functions: {
    ...
    "newFanTicket(string,string,uint32,uint256,address,uint8,bytes32,bytes32)": FunctionFragment;
    ...
    "tokenIdToOriginAddress(uint32)": FunctionFragment;
    "tokenIdToOriginChainId(uint32)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "tokenIdToOriginAddress",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "tokenIdToOriginChainId",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export class InterChainFanTicketFactory extends BaseContract {
  ...
  interface: InterChainFanTicketFactoryInterface;
  ...
  functions: {
    ...
    tokenIdToOriginAddress(
      arg0: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[string]>;

    tokenIdToOriginChainId(
      arg0: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;
